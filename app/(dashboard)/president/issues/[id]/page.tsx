...
import IssueManage from './issue-manage'
...
export default async function PresidentIssueDetailPage({
  params,
}: {
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {escalated && (
        <div className="flex items-center gap-2.5 px-4 py-3 bg-red-50 border border-red-200 rounded-xl mb-6 text-red-700">
          ...
          <p className="text-sm font-medium">This issue has been escalated — it has been open for more than 7 days</p>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-card p-6">
            ...
            <dl className="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
              ...
              <div>
                <dt className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-0.5">Raised By</dt>
                <dd className="text-slate-800">
                  {issue.raisedBy.name ?? '—'}
                  <span className="block text-xs text-slate-500">{issue.raisedBy.email}</span>
                </dd>
              </div>
              <div>
                  ...
                  <div key={comment.id} className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <Badge
                          variant={
                            comment.author.role === 'PRESIDENT' || comment.author.role === 'SUPER_ADMIN'
                              ? 'info'
                              : 'muted'
                          }
                        >
        ...
        <div className="lg:col-span-1">
          <IssueManage
            ...
            currentAssignedTo={issue.assignedTo}
          />
        </div>
      </div>
    </div>
